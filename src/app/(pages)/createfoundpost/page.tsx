...
import createFoundItem from '@/app/api/createFoundItem';
...
const CreateFoundPost = () => {
    ...
    const foundPostData = {
        ...
        createdAt: new Date(),
        location: location,
        foundDate: value ? formatter.format(value.toDate(getLocalTimeZone())) : "--",
        itemStatus: "Active",
    ...
    const handleSubmit = async () => {
        ...
        try {
            await createFoundItem(foundPostData);
            router.push('/founditems'); // Redirect to /lostitems after successful creation
          } catch (error) {
