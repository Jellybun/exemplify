        ...
        <>
            <main id="content">
                ...
                <div className="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
                    ...
                    <span className="text-neutral-300 animte duration-500 animate-pulse">WhitBox:</span> 
                    </h1>
                    <div className="max-w-4xl">
                    <p className="mt-5 text-neutral-400 text-lg">
                    Whitbox нь танай нийгэмлэгийг холбосноор алдагдсан зүйлсийг олох, буцааж өгөхөд хялбар болгоно.
                    </p>
                    </div>
                </div>
                </div>
                ...
                <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
                    ...
                    Цогц стратегийг удирдан чиглүүж,
                    нягт нямбай саадгүй бүтээгдэхүүн байршуулах.
                    </p>
                    </div>
                    {/* End Title */}
                    {/* Grid */}
                    ...
                    <div>
                        ...
                        <div className="grow pt-0.5 pb-8 sm:pb-12">
                            ...
                            <span className="text-white">Хялбар зүйлсийн жагсаалт: </span>
                            Хэдхэн товшилтоор алдагдсан эсвэл олдсон зүйлсийн дэлгэрэнгүй жагсаалтыг хурдан үүсгэж болно. Эзэмшигчтэй эд зүйлсийг дахин нэгтгэхэд туслах зураг, тайлбар, байршлын дэлгэрэнгүй мэдээллийг оруулаарай.
                            </p>
                        </div>
                        {/* End Right Content */}
                        </div>
                        ...
                        <div className="grow pt-0.5 pb-8 sm:pb-12">
                            ...
                            Манай хайлтын хүчирхэг шүүлтүүрийг ашиглан алдагдсан зүйлсийг хялбархан олоорой. Хайж буй зүйлээ олох боломжоо нэмэгдүүлэхийн тулд хайлтаа ангилал, түлхүүр үг, байршил, огноогоор нь сайжруул.
                            </p>
                        </div>
                        {/* End Right Content */}
                        </div>
                        ...
                        <div className="grow pt-0.5 pb-8 sm:pb-12">
                            ...
                            <span className="text-white">Олон нийтийн хамтын ажиллагаа: </span>
                            Бие биедээ туслах зорилготой хэрэглэгчдийн дэмжлэгтэй нийгэмлэгт нэгдээрэй. Удирдамжийг хуваалцаж, зөвлөгөө өгч, алдагдсан зүйлсийн талаар мэдээлэл түгээ.
                            </p>
                        </div>
                        {/* End Right Content */}
                        </div>
                        ...
                        <div className="grow pt-0.5 pb-8 sm:pb-12">
                            ...
                            Манай суурилуулсан мессежийн системээр дамжуулан бусад хэрэглэгчидтэй шууд, аюулгүй харилцаж болно. Өмчлөлийг баталгаажуулж, олсон зүйлийг найдвартай буцааж өгөх ажлыг зохион байгуул.
                            </p>
                        </div>
                        {/* End Right Content */}
                        </div>
                ...
                <div className="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
                    ...
                    <p className="mt-1 text-neutral-400">
                    Whitbox-той холбоотой асуулт, санал хүсэлт, тусламж хэрэгтэй байна уу? Бид танд туслахаар ирлээ!
                    </p>
                    </div>
                    {/* End Title */}
                    {/* Grid */}
